package jmaster.io.hackerthon.ws.wellknownconstants;

/**
 * This class contains all constants related to folders.
 *
 * @author Zakaria Maaraki
 */
public abstract class WellKnownFolders {
    
    private WellKnownFolders() {}
