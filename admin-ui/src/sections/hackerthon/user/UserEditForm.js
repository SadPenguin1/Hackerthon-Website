...
import { updateMediaUserEmailAPI, updateMediaUserInfoAPI, updateMediaUserPhoneAPI, updateMediaUserRoleAPI, updateMediaUserStatusAPI } from '../../../service/hackerthon/hackerthon.user.service';
// ----------------------------------------------------------------------
...
export default function UserEditForm({ isEditRole, isEditEmail, isEditPhone, isEditInfo, isEditStatus, isView, currentUser }) {
  ...
  const onSubmit = async (data) => {
    ...
    if (resp.code === '200') {
      ...
      navigate(PATH_DASHBOARD.hackerthon.users);
    } else
