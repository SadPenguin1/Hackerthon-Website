...
export default function AnalyticsVideoUpdate() {
  ...
  return (
    <Card>
      <CardHeader title={translate('hackerthon.exercise.listExercise')} />
      ...
      <Box sx={{ p: 2, textAlign: 'left' }}>
        <Button size="small" LinkComponent={Link} to={PATH_DASHBOARD.hackerthon.exercises} color="inherit" endIcon={<Iconify icon={'eva:arrow-ios-forward-fill'} />}>
