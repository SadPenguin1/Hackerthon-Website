...
import { getMediaPrivileges, setMediaPrivilegeSearch } from '../../../redux/slices/hackerthon/hackerthon.privilege';
import { deleteMediaPrivilegeAPI, deleteMediaPrivilegesAPI } from '../../../service/hackerthon/hackerthon.privilege.service';
// sections
        ...
        <HeaderBreadcrumbs
          ...
          action={
            <Button
              ...
              to={PATH_DASHBOARD.hackerthon.newPrivilege}
                              ...
                              <TableMoreMenu
                                actions={
                                  <>
                                    ...
                                    <MenuItem component={RouterLink} to={`${PATH_DASHBOARD.hackerthon.root}/privilege/${id}/view`} >
                                      <Iconify icon={'eva:eye-fill'} />
                                      {translate("button.view")}
                                    </MenuItem>

                                    <MenuItem component={RouterLink} to={`${PATH_DASHBOARD.hackerthon.root}/privilege/${id}/edit`} >
