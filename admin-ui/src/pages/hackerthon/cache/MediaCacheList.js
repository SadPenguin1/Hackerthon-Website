...
import { getMediaCaches } from '../../../redux/slices/hackerthon/hackerthon.cache';
import { deleteMediaCacheAPI } from '../../../service/hackerthon/hackerthon.cache.service';
// sections
...
import CacheListToolbar from '../../../sections/hackerthon/cache/CacheListToolbar';
                        ...
                        {TABLE_HEAD.map(head => {
                          ...
                          if (head.id === '')
                            return <TableCell align="right" key={head.id}>
                              <DataGridMoreMenu pathEdit={`${PATH_DASHBOARD.hackerthon.root}/cache/${id}/keys`}
                                pathView={`${PATH_DASHBOARD.hackerthon.root}/cache/${id}/keys`} onDelete={() => handleDeleteItem(id)} />
                            </TableCell>;
