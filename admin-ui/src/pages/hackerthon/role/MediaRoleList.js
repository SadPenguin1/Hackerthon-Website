...
import { getMediaRoles, setMediaRoleSearch } from '../../../redux/slices/hackerthon/hackerthon.role';
import { deleteMediaRoleAPI, deleteMediaRolesAPI } from '../../../service/hackerthon/hackerthon.role.service';
// sections
        ...
        <HeaderBreadcrumbs
          ...
          action={
            <Button
              ...
              to={PATH_DASHBOARD.hackerthon.newRole}
                        ...
                        {TABLE_HEAD.map(head => {
                          ...
                          if (head.id === '')
                            return <TableCell align="right" key={head.id}>
                              <DataGridMoreMenu pathEdit={`${PATH_DASHBOARD.hackerthon.root}/role/${id}/edit`}
                                pathView={`${PATH_DASHBOARD.hackerthon.root}/role/${id}/view`} onDelete={() => handleDeleteItem(id)} />
                            </TableCell>;
