...
import { deleteCategoriesAPI, deleteCategoryAPI } from '../../../service/hackerthon/hackerthon.category.service';
// sections
...
export default function CategoryList() {
  ...
  const TABLE_HEAD = [
    { id: 'id', label: translate('hackerthon.category.id'), alignRight: false, checked: false, sort: true },
    { id: 'title', label: translate('hackerthon.category.title'), alignRight: false, checked: true, sort: true },
    { id: 'orderNo', label: translate('hackerthon.category.orderNo'), alignRight: false, checked: true, sort: true },
    { id: 'metaTitle', label: translate('hackerthon.category.metaTitle'), alignRight: false, checked: false, sort: true },
    { id: 'slug', label: translate('hackerthon.category.slug'), alignRight: false, checked: false, sort: false },
    { id: 'metaDescription', label: translate('hackerthon.category.metaDescription'), alignRight: false, checked: true, sort: false, },
    { id: 'description', label: translate('hackerthon.category.description'), alignRight: false, checked: false, sort: false, },
    { id: 'createdAt', label: translate('hackerthon.category.createdAt'), alignRight: false, checked: true, sort: true },
  ...
  return (
    <Page title={translate('hackerthon.category.listCategory')}>
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs
          heading={translate('hackerthon.category.listCategory')}
          links={[
          ...
          action={
            <Button
              ...
              to={PATH_DASHBOARD.hackerthon.newCategory}
                          ...
                          if (head.id === '')
                            return (
                              <TableCell align="right" key={head.id}>
                                <DataGridMoreMenu
                                  pathEdit={`${PATH_DASHBOARD.hackerthon.root}/category/${id}/edit`}
                                  pathView={`${PATH_DASHBOARD.hackerthon.root}/category/${id}/view`}
