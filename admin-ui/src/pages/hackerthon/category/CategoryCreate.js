...
import CategoryNewForm from '../../../sections/hackerthon/category/CategoryNewForm';
...
export default function CategoryCreate() {
  ...
  return (
    <Page title={isNew ? translate('hackerthon.category.newCategory') : category?.title}>
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs
          heading={isNew ? translate('hackerthon.category.newCategory') : category?.title}
          links={[
            ...
            },
            {
              ...
              href: PATH_DASHBOARD.hackerthon.categories,
            },
            { name: isNew ? translate('hackerthon.category.newCategory') : category?.title || '' },
          ]}
        />
        {error && (isEdit || isView) ? (
          <Box sx={{ py: 3 }}>
