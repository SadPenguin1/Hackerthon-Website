...
import { getExams, setExamSearch } from '../../../redux/slices/hackerthon/hackerthon.exam';
import { deleteExamAPI, deleteExamsAPI } from '../../../service/hackerthon/hackerthon.exam.service';
// sections
...
import ExamExerciseList from '../../../sections/hackerthon/examexercise/ExamExerciseList';
...
export default function ExamList() {
  ...
  const TABLE_HEAD = [
    { id: 'id', label: translate('hackerthon.exam.id'), alignRight: false, checked: false, sort: true },
    { id: 'title', label: translate('hackerthon.exam.title'), alignRight: false, checked: true, sort: true },
    { id: 'metaTitle', label: translate('hackerthon.exam.metaTitle'), alignRight: false, checked: false, sort: true },
    { id: 'slug', label: translate('hackerthon.exam.slug'), alignRight: false, checked: false, sort: false },
    { id: 'metaDescription', label: translate('hackerthon.exam.metaDescription'), alignRight: false, checked: true, sort: false, },
    { id: 'description', label: translate('hackerthon.exam.description'), alignRight: false, checked: false, sort: false, },
    { id: 'createdAt', label: translate('hackerthon.exam.createdAt'), alignRight: false, checked: true, sort: true },
  ...
  return (
    <Page title={translate('hackerthon.exam.listExam')}>
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs
          heading={translate('hackerthon.exam.listExam')}
          links={[
          ...
          action={
            <Button
              ...
              to={PATH_DASHBOARD.hackerthon.newExam}
      ...
      {expandRow && (
        <TableRow hover tabIndex={-1}>
          <TableCell colSpan={checkedColumns.length + 1}>
            <ExamExerciseList item={row} key={id} />
          </TableCell>
        </TableRow>
      )}
    </Fragment>
