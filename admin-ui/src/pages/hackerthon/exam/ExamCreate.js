...
import ExamNewForm from '../../../sections/hackerthon/exam/ExamNewForm';
...
export default function ExamCreate() {
  ...
  return (
    <Page title={isNew ? translate('hackerthon.exam.newExam') : exam?.title}>
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs
          heading={isNew ? translate('hackerthon.exam.newExam') : exam?.title}
          links={[
            ...
            { name: isNew ? translate('hackerthon.exam.newExam') : exam?.title || '' },
          ]}
        />
        {error && (isEdit || isView) ? (
          <Box sx={{ py: 3 }}>
