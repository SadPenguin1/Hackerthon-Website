...
import { getMediaUsers, setMediaUserSearch } from '../../../redux/slices/hackerthon/hackerthon.user';
import UserMoreMenu from '../../../sections/hackerthon/user/UserMoreMenu';
import { deleteMediaUserAPI, deleteMediaUsersAPI } from '../../../service/hackerthon/hackerthon.user.service';
                        ...
                        {TABLE_HEAD.map(head => {
                          ...
                          if (head.id === '')
                            return <TableCell align="right" key={head.id}>
                              <UserMoreMenu id={id}
                                pathView={`${PATH_DASHBOARD.hackerthon.root}/user/${id}/view`}
